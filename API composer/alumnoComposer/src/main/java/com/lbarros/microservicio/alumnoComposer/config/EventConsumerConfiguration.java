package com.lbarros.microservicio.alumnoComposer.config;
...
import com.lbarros.microservicio.alumnoComposer.consumer.EventConsumer;
...
public class EventConsumerConfiguration implements RabbitListenerConfigurer {
	...
	public Queue queueRollback() {
		return new Queue("rollbackAlumno");
	}
